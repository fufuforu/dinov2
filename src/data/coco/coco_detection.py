...
class CocoDetection(torchvision.datasets.CocoDetection):
    ...
    def __init__(self, img_folder, ann_file, transforms, return_masks, remap_category=False, clip_box=True, visibility_thr=-1):
    ...
    def __len__(self):
        return len(self.ids)
        # return min(50, len(self.ids)) #TODO:
...
class ConvertCocoPolysToMask(object):
    def __init__(self, return_masks=False, remap_category=False, clip_box=True, visibility_thr=-1):
        self.return_masks = return_masks
        self.remap_category = remap_category
