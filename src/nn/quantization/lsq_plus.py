...
from .lsq_base import _Conv2dQ, Qmodes, _LinearQ, _ActQ, _LinearQ_v2
...
class ActLSQ(_ActQ):
    ...
    def forward(self, x):
        ...
        if self.training and self.init_state == 0:
            ...
            # if x.min() < -1e-5:
            if x.min() < -1e-5 or x.abs().max() < 1e-5: # has negative values or all values are zeros
        ...
        elif len(x.shape)==5: # deformable multi head attention
            if x.shape[0] == alpha.shape[0]:
        ...
        elif len(x.shape)==6: # deformable multi head attention
            if x.shape[0] == alpha.shape[0]:
                alpha = alpha.unsqueeze(1).unsqueeze(2).unsqueeze(3).unsqueeze(4).unsqueeze(5)
                zero_point = zero_point.unsqueeze(1).unsqueeze(2).unsqueeze(3).unsqueeze(4).unsqueeze(5)
            elif x.shape[1] == alpha.shape[0]:
                alpha = alpha.unsqueeze(0).unsqueeze(2).unsqueeze(3).unsqueeze(4).unsqueeze(5)
                zero_point = zero_point.unsqueeze(0).unsqueeze(2).unsqueeze(3).unsqueeze(4).unsqueeze(5)
            elif x.shape[2] == alpha.shape[0]:
                alpha = alpha.unsqueeze(0).unsqueeze(0).unsqueeze(3).unsqueeze(4).unsqueeze(5)
                zero_point = zero_point.unsqueeze(0).unsqueeze(0).unsqueeze(3).unsqueeze(4).unsqueeze(5)
            elif x.shape[3] == alpha.shape[0]:
                alpha = alpha.unsqueeze(0).unsqueeze(0).unsqueeze(0).unsqueeze(0).unsqueeze(4).unsqueeze(5)
                zero_point = zero_point.unsqueeze(0).unsqueeze(0).unsqueeze(0).unsqueeze(0).unsqueeze(4).unsqueeze(5)
            elif x.shape[4] == alpha.shape[0]:
                alpha = alpha.unsqueeze(0).unsqueeze(0).unsqueeze(0).unsqueeze(0).unsqueeze(5)
                zero_point = zero_point.unsqueeze(0).unsqueeze(0).unsqueeze(0).unsqueeze(0).unsqueeze(5)
            elif x.shape[5] == alpha.shape[0]:
                alpha = alpha.unsqueeze(0).unsqueeze(0).unsqueeze(0).unsqueeze(0).unsqueeze(5)
                zero_point = zero_point.unsqueeze(0).unsqueeze(0).unsqueeze(0).unsqueeze(0).unsqueeze(5)

        # x = round_pass((x / alpha + zero_point).clamp(Qn, Qp))
        x = round_pass((x / (alpha + 1e-8) + zero_point).clamp(Qn, Qp))
